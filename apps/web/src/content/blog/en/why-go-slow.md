...
---
id: "why-go-slow"
title: "Why Go Slow? + Follow Us On Instagram and YouTube"
date: "2026-04-27"
description: "Sidestep the information economy circus by playing a different game."
type: "post"
byline: "David Eads"
editors:
  - "Tory Lysik"
...
tags:
  - "field-notes"
lang: "en"
previewImage: "/images/pando_forest_01.jpg"
hidePreview: false
---
...
<ResizedImage
  src="/images/pando_forest_01.jpg"
  alt="The long-lived Pando aspen forest"
  width={800}
  caption="The [Pando aspen clone](https://en.wikipedia.org/wiki/Pando_%28tree%29) in Utah is thought to be the oldest and largest living organism in the world, estimated to be around 16,000 years old. Photo by [John Zapell](https://flickr.com/photos/107640324@N05/30469976897/in/photostream/), Intermountain Forest Service."
  figureClass="my-6 max-w-full"
  class="h-auto"
/>

We wrote a post called “[Why Go Fast?](https://recoveredfactory.net/en/why-go-fast)” earlier this year because we like rolling out features quickly, and we've made a bunch of improvements large and small to our projects since we launched three months ago. Now, we're doing [video](https://www.instagram.com/recoveredfactory) and recently posted about our improvements to [Missouri Vehicle Stops](https://www.instagram.com/p/DXht3JTgNXr/), which now includes 25 years of data. 


<a href="https://www.instagram.com/p/DXht4JTgNXr/">
<ResizedImage
  src="/images/rf_25years_ig_y2k.png"
  alt="A screenshot of our video about the new data, with David Eads talking about how the data goes back to Y2K."
  width={800}
  caption="Follow us on [Instagram](https://www.instagram.com/recoveredfactory) and [YouTube](https://www.youtube.com/@RecoveredFactory)."
...
Sarah Alvarez wrote [about this recently at NewsFix](https://www.newsfix.blog/qwe-need-to-build-a-slower-system-and-quick/): "Speed, instead of need, is the currency" of the attention economy. She points to Outlier Media's [Profits and Losses](https://outliermedia.org/detroit-foreclosure-crisis-wayne-county-profits-losses/?ref=recoveredfactory.net) project, which worked to inform Detroiters who experienced tax foreclosure about court-mandated money they were owed from the city’s subsequent sale of their property. They had a sixteen-week deadline from the time the relief was announced to the deadline for former homeowners to claim the funds, so they had to hustle and enlist an “army” of civic volunteers — but with a speed and cadence driven by real need and strategy, not by feeding the algorithm or wowing funders with slick packaging. 
...
The Profits and Losses project demonstrates a deep understanding of this kind of strategic thinking. They set up a brilliantly [utilitarian explainer](https://sites.google.com/outliermedia.org/wcou/home). They offered one-on-one assistance. They reported news incrementally along the way. 
...
We expanded the timeframe of Missouri Vehicle Stops and added Census identifiers after input and discussion with Jon Ben-Menachem, a PhD candidate at Columbia University [using the data](https://bsky.app/profile/jbenmenachem.com/post/3mi7r2kemh225) in statistical models for his [research into sundown towns](https://osf.io/preprints/socarxiv/faz4k_v1). We're adding a download in a "[wide](https://en.wikipedia.org/wiki/Wide_and_narrow_data)" data format because local groups, led by activist Donald Love, have traditionally used wide formats for easy desktop spreadsheet browsing. ([The data is coming, Mr. Love](https://github.com/recoveredfactory/missouri-vsr-processing/issues/16)\!) We hope to add MCP support by summer, in part thanks to a suggestion from Jason Radford, managing director at the [National Internet Observatory](https://www.nationalinternetobservatory.org/). 

<ResizedImage
  src="/images/rf_25years_homepage.png"
  alt="The homepage of Missouri Vehicle Stops, showing a long decline in consent searches."
  width={600}
  caption="We added 20 years of historical data to [Missouri Vehicle Stops](https://vsr.recoveredfactory.net)."
  figureClass="my-6 max-w-sm"
  class="h-auto"
/>
...
<ResizedImage
  src="/images/pando_forest_02.jpg"
  alt="The long-lived Pando aspen forest"
  width={600}
  caption="If the Pando clone can turn glorious colors every fall roughly 16,000 times, your newsroom can maintain a database for a few years. Photo by [John Zapell](https://flickr.com/photos/107640324@N05/30469976897/in/photostream/), Intermountain Forest Service."
  figureClass="my-6 max-w-md"
  class="h-auto"
/>
