---
id: "nicar-pink-pigeons"
title: "We Brought Pink Pigeon Stickers to NICAR. Here's Why. "
date: "2026-03-18"
description: "To survive extinction, the pink pigeon just needed space to be itself. This year's NICAR felt like that."
type: "post"
byline: "Tory Lysik"
editors:
  - "Ash Ngu"
...
tags:
  - "field-notes"
lang: "en"
previewImage: "/images/pink-pigeon.jpg"
---
...
If you were in Indianapolis for the National Institute of Computer Assisted Reporters ([NICAR](https://www.ire.org/training/conferences/nicar-2026/)) conference at the beginning of March and checked out the free stuff table, you might have seen a pink pigeon sticker with a green background on the table. That was us\!

<ResizedImage
  src="/images/pink-pigeon-stickers.jpg"
  alt="Recovered Factory 'Pink Pigeon' stickers at NICAR 2026"
  width={1200}
  figureClass="my-6"
  class="w-full h-auto"
/>
...
But why pigeon stickers? And why pink? This little pigeon has a great backstory that is a beautiful metaphor for [Recovered Factory’s](https://recoveredfactory.net/en) approach to journalism. 
...
<ResizedImage
  ...
  alt="A photo of a pink pigeon on a tree branch"
  width={1200}
  figureClass="my-6"
  class="w-full h-auto"
  caption="Photo by [Alex (arcalexx)](https://www.flickr.com/photos/29229281@N00/6329183903/), [some rights reserved](https://creativecommons.org/licenses/by/2.0/deed.en)."
/>

I spent the entire train ride home researching pink pigeons. The wild pink pigeon is only found on the Island of [Mauritius](https://mauritiusnow.com/) off the coast of Madagascar in the Indian Ocean. They are introverted, curious foragers and gentle opportunists. They’re not built for speed or aggression, and definitely aren’t the flashiest thing in the room. Feral cats like house cats tend to attack them a lot. Also bigger rats. They aren't the fastest animal at getting away. In the early 1970s, the pink pigeon nearly became extinct due to habitat loss and human introduction of invasive predators. By 1990, there were only 9 birds left in the world and less than 2 percent of their native forest habitat left on Mauritius, their native land for thousands of years, compared to a few hundred years ago.

But then — scientists made a plan, and quickly and strategically intervened. By 2010, there were about 400 pink pigeons around the world. And as of last year, there are 400 in the wild alone and upwards of 600 when adding in  those housed in at least seven zoos worldwide (that I could find) and [scientific conservation programs.](https://colossalfoundation.org/project/pink-pigeon-genetic-rescue/#:~:text=Project%20Details:,to%20about%20600%20individuals%20today.)  

The species still has a long way to go and is, by no means, in the clear. They are still classified as ["vulnerable"](https://www.iucnredlist.org/) (they would have to drop below 50 to be “endangered” or “critically endangered” again). But they came back from the brink and have held onto enough genetic diversity to thrive.
...
The pink pigeon isn't a perfect metaphor, and I'll be the first to admit it. But the part I keep returning to is this: the pigeon just needed space to do what it already knew how to do. It didn't need to become something else. It needed the right conditions and care. Part of that for us, that's transparency–  doing the work in public, showing the process as we go. It's trust built slowly with an audience that's actually paying attention. And it's a willingness to take risks, because that's the thing that keeps the work from going flat.Just the room to do what we already know how to do and make the world a better place.
