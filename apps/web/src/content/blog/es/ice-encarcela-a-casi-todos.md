...
*Datos divulgados recientemente muestran que, bajo Trump, ICE ingresó a detención a cerca del 90% de las casi 390,000 personas que arrestó en el interior. Esa tasa casi universal no es nueva: ya había subido a casi el 90% para el final de los años de Biden. Pero ahora ICE realiza aproximadamente el triple de arrestos, lo que hace que la detención sea tanto de alta probabilidad como de alto volumen. La expulsión es ahora el desenlace más común: más de 261,000 personas —cerca de dos tercios de las arrestadas— terminaron en deportación o salida.*

*Este análisis y texto fue generado por [PromptQL](https://promptql.io), una plataforma colaborativa impulsada por IA que da sentido a fuentes de datos, documentos y conocimiento tribal dispersos. Estoy asesorando a la empresa y considero que su plataforma es lo suficientemente potente y confiable como para apoyarme en ella en experimentos como este y en nuestros [resúmenes de noticias estatales](https://287g.recoveredfactory.net/es/states) de 287(g) Watch.*
...
Registros recién vinculados del [Deportation Data Project](https://deportationdata.org) muestran ahora a quién está capturando el gobierno y qué ocurre con esas personas: casi todas las que ICE arresta en el interior son encarceladas, y el desenlace más común es la deportación. Los arrestos se triplicaron aproximadamente después del 20 de enero de 2025, mientras que la tasa de detención —que ya venía subiendo durante los años de Biden— se ubica ahora en una meseta del 90%.
...
## Dos tercios de los arrestados no tienen ninguna condena penal
...
Los comunicados de prensa de DHS citados aquí son de mediados de 2026, los meses más recientes disponibles, mientras que los registros de arrestos solo llegan hasta principios de 2026 porque los datos llegan con rezago. Trate los comunicados como el mensaje actual de la campaña, no como un comentario sobre los meses específicos que aparecen en los datos.
...
*Cada cifra de este artículo, y las matemáticas detrás de ella: [el registro de cifras (en inglés)](/en/ice-jails-nearly-everyone-numbers).*
